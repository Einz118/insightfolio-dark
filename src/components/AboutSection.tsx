      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-slide-up">
            ...
            of educators, developers, and innovators committed to creating impactful learning experiences.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl p-8 border border-primary/20">
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              To democratize access to quality education by leveraging cutting-edge technology, fostering 
              inclusive learning environments, and empowering communities to build a more educated and 

  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center section-padding overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={heroImage}
          alt="Educational Technology Innovation"
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div className="animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            We're an innovative ed-tech startup dedicated to creating cutting-edge educational solutions 
            that empower learners, educators, and communities worldwide. Our mission is to make quality 
            education accessible to everyone through technology.
          </p>
        ...
        <div className="hidden lg:block relative">
          <div className="w-full h-96 bg-gradient-to-br from-primary/20 to-accent/20 rounded-3xl backdrop-blur-sm border border-primary/20 animate-float" 
